const DynamicTodo = async(props:any)=>{
    ...
    console.log("SingleTodoRespnose", res)
    return(
    ...
    {props.params.id} <br/> </h1>
    <h1 className="text-[23px] font-bold  text-black ml-4 mt-6 "> <p className="text-[20px] underline font-bold"> Title:{res.title}<br/></p></h1>
    <h1 className="text-[17px] text-blue-800 font-light ml-5  mt-3"><p className="text-[21px] font-serif"> Body:{res.body}<br/></p></h1>
    </main>
